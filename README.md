...
The goal of this project is to design and train a reinforcement learning agent capable of learning an optimal continuous control policy for a DC motor system. The agent observes system error signals and outputs a continuous control action. Includes system modeling, reward design, and RL implementation, compared with traditional control methods for stability, convergence, and performance evaluation.The trained agent was later adapted to control a physical tank level system using a pneumatic valve.
